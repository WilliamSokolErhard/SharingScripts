...
public class SharingIDgenerator : MonoBehaviour
{
    ...
    void Start() {
        ...
        if (isMaster)
        {
            ...
            print("SharingIDgenerator not on a master object. It's on this object: " + gameObject.name);
    ...
    IEnumerator AddSharingScriptsToAllObjectsInThisParent()
    {
        ...
        yield return null;
        SharingManager.indexedObjs = objectsInScene;
