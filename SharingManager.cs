...
public class SharingManager : Singleton<SharingManager> {
    ...
    {
        print("SharingManager: Input Down Being Sent from GameObject: " + getSharedObjectFromID(Object).name);
    ...
    public void InputDownRPC(int Object)
    {
        ...
        print("SharingManager: Input Down RPC Recieved for object number: " + Object + ". Which is of name: " +getSharedObjectFromID(Object));

        if (getSharedObjectFromID(Object).GetComponent<ClickSharer>() != null)
            getSharedObjectFromID(Object).GetComponent<ClickSharer>().time();
        else
            print("SharingManager: WARNING: There's an object without a click sharer: " + getSharedObjectFromID(Object).name);
    ...
    {
        print("SharingManager: Input Click Being Sent");
    ...
    {
        print("SharingManager: Focus Enter Being Sent");
    ...
    {
        print("SharingManager: Focused entered RPC Recieved for object number: " + Object + ". Which is of name: " + getSharedObjectFromID(Object));
    ...
    {
        print("SharingManager: Focus Exit Being Sent");
    ...
    {
        print("SharingManager: Input Exit RPC Recieved for object number: " + Object + ". Which is of name: " + getSharedObjectFromID(Object));
